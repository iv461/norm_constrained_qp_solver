...
/// Computes the optimal solution given the optimal Lagrange multiplier l (root of the secular equation) and given the eigenvalue decomposition Q, D of the matrix
template<typename Scalar, int Dim>
Eigen::Vector<Scalar, Dim> extract_solution(
